...
def decide_attack(character: Character, possible_attacks: list[AttackAction], game_state: GameState, other_attacks: list[AttackAction]) -> AttackAction | None:
    ...
    for attack in possible_attacks:
        ...
        if attack.type == AttackActionType.CHARACTER and any([a.attacking_id == attack.attacking_id for a in other_attacks]):
            continue
...
def decide_ability(character: Character, possible_abilities: list[AbilityAction], game_state: GameState, other_abilities: list[AbilityAction]) -> AbilityAction | None:
    zombies: list[Character] = [c for c in game_state.characters.values() if c.is_zombie]
